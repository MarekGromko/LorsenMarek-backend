...
public class EpisodeRatingController {
    final private EpisodeRatingService episodeRatingService;

    /**
     * Create a new {@link EpisodeRatingController}
     * @param episodeRatingService depends on {@link EpisodeRatingService}
     */
    public EpisodeRatingController(
